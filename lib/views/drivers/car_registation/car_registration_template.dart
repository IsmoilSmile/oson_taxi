...
import 'package:oson_taxi/views/drivers/car_registation/pages/document_uploaded_page.dart';
import 'package:oson_taxi/views/drivers/car_registation/pages/location_page.dart';
import 'package:oson_taxi/views/drivers/car_registation/pages/upload_document_page.dart';
import 'package:oson_taxi/views/drivers/car_registation/pages/vehical_color_page.dart';
import 'package:oson_taxi/views/drivers/car_registation/pages/vehical_make.dart';
import 'package:oson_taxi/views/drivers/car_registation/pages/vehical_model_page.dart';
import 'package:oson_taxi/views/drivers/car_registation/pages/vehical_model_year_page.dart';
import 'package:oson_taxi/views/drivers/car_registation/pages/vehical_number_page.dart';
import 'package:oson_taxi/views/drivers/car_registation/pages/vehical_type_page.dart';
